...
def doesItContainProfanity(value):
    ...
    'crack','crap','creampie','credit card','crossdresser','cuckold','cumshot','cunnilingus','cunt','cyberturf',
    ...
    'lezzian',' licked','lingerie','lipshits','lipshitz','lolita','lovemaking','mamhoon',
    ...
    'orospu','outercourse','p0rn','Packer','packie','packy','paedophile','paki','pakie','paky',
    ...
    'quim','qweers','qweerz','qweir','r@ygold','raghead','rape','raping','rapist','rautenberg',
    ...
    'talsarta','teen','teen%20boy','teen%20girl','teenage','teets','teez','tenoretic','tenormin',
    ...
    'tritace','tubgirl','turd','tushy','twat','twink','twinkie','ultram','underage','undressing','upskirt',
    'urethra','urophilia','va1jina','vag1na','vagiina','vagina','vagisil','vaj1na','vajina',
    'vasotec','viagra','vibrator','vittu','vorarephilia','voyeur','vullva','vulva','w00se','w0p',
